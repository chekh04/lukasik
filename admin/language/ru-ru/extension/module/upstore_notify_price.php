<?php
// Heading
$_['heading_title']                       			= '<span style="color:#000"><img style="min-width:30px; margin-right:5px;" src="view/image/upstore_icon.svg"><span class="hidden">Up</span>store - Сообщить о снижении цены, новых акциях</span>';
...
$_['column_current_price'] 								= 'Текущая цена';
$_['column_request_price'] 								= 'Цена на момент заявки';
$_['column_send_request_price'] 							= 'Цена на момент отправки';
...
<div>
	...
	<br/><b>~price~</b><i style="font-weight:400"> - Цена</i>
	<br/><b>~special~</b><i style="font-weight:400"> - Акция</i>
	<br/><b>~old_price~</b><i style="font-weight:400"> - Старая Цена</i>
	<br/><b>~old_special~</b><i style="font-weight:400"> - Старая Акция</i>
