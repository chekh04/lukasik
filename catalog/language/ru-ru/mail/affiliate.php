...
$_['text_services'] = "В партнерском разделе вы можете получить реферальный код и реферальные ссылки, отслеживать комиссионное вознаграждение и изменить параметры аккаунта.";
