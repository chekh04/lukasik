...
*/
$_['text_your_affiliate'] = "Информация партнера";
$_['entry_customer_group'] = "Группа";
$_['error_custom_field'] = "%s – обязательный параметр";
$_['error_cheque'] = "Укажите имя плательщика чека";
$_['error_paypal'] = "Адрес электронной почты PayPal неправильно указан";
$_['error_bank_account_name'] = "Укажите имя аккаунта";
