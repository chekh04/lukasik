<?php
class ControllerExtensionModuleUpstoreArticleFeatured extends Controller {
	public function index($setting) {
		...
		if (!empty($setting['article'])) {
			...
			foreach ($articles as $article_id) {
				$article_info = $this->model_upstore_article->getArticle($article_id);
		...
		$data['module'] = $module++;
		if ($data['articles']) {
			return $this->load->view('extension/module/upstore_article_featured', $data);
		}
		}
	}
}