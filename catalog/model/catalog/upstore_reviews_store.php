<?php
class ModelCatalogUpstoreReviewsStore extends Model {
	...
	public function getReviewsThemeRating() {
		...
		if (!empty($results)) {
			foreach ($results as &$result) {
				$result['stars'] = $this->storeReviewsRatingStars($result['avg_rating']);
			}
		}
	...
	public function getAvgRatingCustomer($reviews_store_id) {
		...
		if (!empty($query->row)) {
			$stars = $this->storeReviewsRatingStars($query->row['avg_customer_rating']);
		}
	...
	public function storeReviewsRatingStars($rating) {
