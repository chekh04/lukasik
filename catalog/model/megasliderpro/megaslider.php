...
class ModelMegasliderproMegaslider extends Model {
	...
	public function getChmSlider($banner_id) {
	...
	public function getSmallSlider($megasliderpro_id) {
		$query = "SELECT * FROM " . DB_PREFIX .  "megasliderpro_small_slider WHERE megasliderpro_id = '" . (int)$megasliderpro_id . "'";
